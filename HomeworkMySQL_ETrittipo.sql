...
ALTER TABLE actor 
ADD COLUMN description varchar(45) NULL AFTER last_name;

-- * 3b. Very quickly you realize that entering descriptions for each actor is too much effort. Delete the `description` column.

ALTER TABLE actor 
CHANGE COLUMN description description BLOB NULL DEFAULT NULL ;
...
SELECT film.title, COUNT(inventory_id) AS number_of_copies
FROM film
JOIN inventory 
